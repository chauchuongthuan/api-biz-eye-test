...
export class TransformerExpertiseService {
   private locale;
   ...
   transformExpertiseList(docs, appendDetailData = {}, isTranslate = false, appendListData = {}) {
      const self = this;
      if (docs.docs) {
         docs.docs = docs.docs.map(function (doc) {
            return self.transformExpertiseDetail(doc, appendDetailData, isTranslate);
         });
         return {
            ...docs,
            ...appendListData,
   ...
   transformExpertiseDetail(doc, appendData = {}, isTranslate = false) {
